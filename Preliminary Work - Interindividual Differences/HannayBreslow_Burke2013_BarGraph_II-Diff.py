...
plt.plot(r + width, [-0.23653804417646285, 0.18080009999820135, 0.7690794651279518, 1.221421273841564],'o',color = 'fuchsia',label = 'Increased Light Intensity')
plt.plot(r + width, [-0.2363937376018157, 0.08931684235497528, 0.9157121172801084, 1.2677500901559142],'o',color = 'purple',label = 'Decreased Light Intensity')
