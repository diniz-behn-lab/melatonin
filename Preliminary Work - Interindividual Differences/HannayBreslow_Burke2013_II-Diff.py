...
model_BLM.integrateModel(24*5,tstart=0.0,initial=IC, melatonin_timing=23-5.75, melatonin_dosage=5.0,schedule=3) 

model_DLM = HannayBreslowModel()
model_DLM.integrateModel(24*5,tstart=0.0,initial=IC, melatonin_timing=23-5.75, melatonin_dosage=5.0,schedule=4) 
