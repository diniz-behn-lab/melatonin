...
#plt.axvspan(0, 5.8, facecolor='mediumblue', alpha=0.3)
#plt.axvspan(20, 29.8, facecolor='mediumblue', alpha=0.3)
#plt.axvspan(44, 47.9, facecolor='mediumblue', alpha=0.3)
plt.axvspan(0, 8.2, facecolor='darkorchid', alpha=0.3)
plt.axvspan(22, 32.1, facecolor='darkorchid', alpha=0.3)
plt.axvspan(46, 47.9, facecolor='darkorchid', alpha=0.3)
