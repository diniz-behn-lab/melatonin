# -*- coding: utf-8 -*-
"""
Created on Thu Mar  7 08:14:55 2024
...
psi_mod2pi = np.mod(model.results[360:600,1],2*np.pi)
...
DLMO_psi = model.ts[DLMO_index+360] # closest to psi = 1.30899
CBTmin = model.ts[CBTmin_index+360] # closest to psi = 3.14159

# By threshold definition (10 pg/mL in plasma)
DLMO_threshold = 10

plasma_mel_concentrations = model.results[360:600,4]/4.3 # converting output to pg/mL
times = model.ts[360:600] # defining times from first 24hrs 
...
DLMO_H2 = times[plasma_mel[0]-1] # finding the time corresponding to the last index below threshold, DLMO
DLMOff = times[plasma_mel[-1]-1] # finding the time corresponding to the first index below threshold, DLMOff
