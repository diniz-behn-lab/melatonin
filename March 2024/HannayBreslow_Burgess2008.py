...
3.0 mg dose of exogenous melatonin 
...
Burgess2008_fittedcurve_x = [0.117,
                             0.515,
                             0.888,
                             1.26,
                             1.65,
...
Burgess2008_fittedcurve_y = [0.46,
                             0.387,
                             0.34,
                             0.291,
                             0.261,
...
plt.plot(Burgess2008_fittedcurve_x,Burgess2008_fittedcurve_y,'-',color='grey',lw=3)
plt.plot(Burgess_2008_PRC_times, Burgess_2008_PRC, 'o',color='black')
plt.xticks(np.arange(0, 26, 4))
plt.title("3 Pulse PRC to 3mg Exogenous Melatonin")
plt.xlabel("Time After DLMO (hours)")
