...
# Set parameter values 
    def set_params(self):
        ...
        self.M_max = 0 # Being optimized! #0.019513 # Breslow 2013
        self.H_sat = 300 # changed to be our max #861 # Breslow 2013
        self.sigma_M = 1 # changed so that it saturates at H_sat #50 # Breslow 2013
...
def run_HannayBreslow_PRC(params):
    ...
    model_4.set_melatonin_prc_params(params)
    ...
    model_15.set_melatonin_prc_params(params)
