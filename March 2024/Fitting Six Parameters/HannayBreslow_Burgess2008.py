...
# Set parameter values 
    def set_params(self):
        ...
        self.H_sat = 300 # pmol/L, what our max is in this model #861 # Breslow 2013
        self.sigma_M = 1 # pmol/L, so that the saturating begins at H_sat #50 # Breslow 2013
...
plt.axhline(1000, color='green',linestyle='dashed')
#plt.axvline(22+24)
plt.xlabel("Time (hours)")
plt.ylabel("Melatonin Concentration (pg/mL)")
