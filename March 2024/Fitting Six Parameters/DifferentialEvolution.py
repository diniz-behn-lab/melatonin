...
Optimize the melatonin forcing parameters (B1, B2, theta_M1, theta_M2, epsilon) and the modifying constant (M_max)
...
now = time.time()
# To be optimized: [(B_1), (theta_M1), (B_2), (theta_M2), (epsilon), (M_max)]

# Set bounds for the five parameters to be optimized
#bounds = [(-1, 1), (0, np.pi/2), (-1, 1), (0, np.pi/2), (-0.5, 0.5)]
bounds = [(-3, 3), (-np.pi/2, np.pi/2), (-3, 3), (-np.pi/2, np.pi/2), (-0.5, 0.5), (0,5)]
