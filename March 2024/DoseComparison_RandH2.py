...
plt.plot(model_none.ts[timing*10:timing*10+100],model_none.results[timing*10:timing*10+100,4]/4.3,lw=3)
plt.plot(model_01.ts[timing*10:timing*10+100],model_01.results[timing*10:timing*10+100,4]/4.3,lw=3)
plt.plot(model_03.ts[timing*10:timing*10+100],model_03.results[timing*10:timing*10+100,4]/4.3,lw=3)
plt.plot(model_05.ts[timing*10:timing*10+100],model_05.results[timing*10:timing*10+100,4]/4.3,lw=3)
plt.plot(model_1.ts[timing*10:timing*10+100],model_1.results[timing*10:timing*10+100,4]/4.3,lw=3)
#plt.plot(model_2.ts[timing*10:timing*10+100],model_2.results[timing*10:timing*10+100,4]/4.3,lw=2)
plt.plot(model_3.ts[timing*10:timing*10+100],model_3.results[timing*10:timing*10+100,4]/4.3,lw=3)
...
# Plotting R
plt.plot(model_none.ts,model_none.results[:,0],lw=3)
plt.plot(model_01.ts,model_01.results[:,0],lw=3)
plt.plot(model_03.ts,model_03.results[:,0],lw=3)
plt.plot(model_05.ts,model_05.results[:,0],lw=3)
plt.plot(model_1.ts,model_1.results[:,0],lw=3)
#plt.plot(model_2.ts,model_2.results[:,0],lw=2)
plt.plot(model_3.ts,model_3.results[:,0],lw=3)
#plt.plot(model_4.ts,model_4.results[:,0],lw=2)
plt.plot(model_5.ts,model_5.results[:,0],lw=3)
...
plt.plot(model_none.ts[timing*10:timing*10+100],model_none.results[timing*10:timing*10+100,0],lw=3)
plt.plot(model_01.ts[timing*10:timing*10+100],model_01.results[timing*10:timing*10+100,0],lw=3)
plt.plot(model_03.ts[timing*10:timing*10+100],model_03.results[timing*10:timing*10+100,0],lw=3)
plt.plot(model_05.ts[timing*10:timing*10+100],model_05.results[timing*10:timing*10+100,0],lw=3)
plt.plot(model_1.ts[timing*10:timing*10+100],model_1.results[timing*10:timing*10+100,0],lw=3)
#plt.plot(model_2.ts[timing*10:timing*10+100],model_2.results[timing*10:timing*10+100,0],lw=2)
plt.plot(model_3.ts[timing*10:timing*10+100],model_3.results[timing*10:timing*10+100,0],lw=3)
#plt.plot(model_4.ts[timing*10:timing*10+100],model_4.results[timing*10:timing*10+100,0],lw=2)
plt.plot(model_5.ts[timing*10:timing*10+100],model_5.results[timing*10:timing*10+100,0],lw=3)
